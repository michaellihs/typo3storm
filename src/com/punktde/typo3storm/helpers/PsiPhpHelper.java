 ...
 *
 * Source code was taken from the Magicento project (www.magicento.com)
 *
...
public class PsiPhpHelper {
    ...
    public static List<PsiElement> getChainedMethodReferences(PsiElement psiElement)
    {
        ...
        PsiElement childMethodReference = com.magicento.helpers.PsiPhpHelper.findFirstChildOfType(psiElement, METHOD_REFERENCE);
        while(childMethodReference != null){
            methods.add(childMethodReference);
            childMethodReference = com.magicento.helpers.PsiPhpHelper.findFirstChildOfType(childMethodReference, METHOD_REFERENCE);
        }
...
//        System.arraycopy(second, 0, result, first.length, second.length);
    ...
    {
        return com.magicento.helpers.PsiPhpHelper.findFirstParentOfType(child, com.magicento.helpers.PsiPhpHelper.CLASS, com.magicento.helpers.PsiPhpHelper.CLASS);
    }
...
//                    }
    ...
    {
        List<PsiElement> parameterChildren = com.magicento.helpers.PsiPhpHelper.getFullListOfChildren(parameter); // parameter.getChildren();
